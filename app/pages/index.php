...
<head>
  ...
  <title>GhienDuLich - Liên Hệ</title>
...
<body>
  ...
  <header>
    ...
    <div class="header-text">
      <h1 style="color: #f05123;">WELCOME TO VIETNAM</h1>
      <h1>NƠI MÀ BẠN CÓ THỂ TẬN HƯỞNG KỲ NGHỈ MƠ ƯỚC</h1>
      <p>
        Du lịch đến bất kì nơi đâu đến Việt Nam mà không cần phải đi vòng quanh
      </p>
      <section class="contact">
        <?php
        if (isset($_COOKIE['email'])) {
          if ($roles == 0) {
            echo '<a class="btn" href="../admin/index.php">Quay về quản trị</a>';
          }
        } else {
          echo '<div class="login">
            <button class="js-contact">Đăng Nhập</button>
            <button class="js-register" data-toggle="modal" data-target="#exampleModal">Đăng ký</button>
          </div>';
        }
        ?>
      </section>
  ...
  <div class="container">
    <h1 class="text-center my-3">Du lịch trải nghiệm trực tuyến</h1>
    <p class="text-center">
      Hình thức này như ngọn lửa “giữ ấm” cho hoạt động du lịch gần như bị “đóng băng” do ảnh hưởng của dịch COVID-19.
      Trước tác động tiêu cực của dịch COVID-19, để giữ vững vị trí là điểm đến du lịch hấp dẫn trong bối cảnh thích ứng an toàn mới, ngành du lịch tận dụng nền tảng số để triển khai, đẩy mạnh công tác quảng bá, xúc tiến du lịch.
  ...
  <main class="container">
    <section class="introduce content-section">
      <div class="introduce-content">
        <h1>Các Địa Điểm Đang Hot</h1>
        <h6 class="section-sub-heading">Trải nghiệm Khám Phá</h6>
      </div>
      <div class="justify-content-xxl-center col-6">
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="image/sapa.png" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <h5>Sapa trong sương - Nét đẹp của thị trấn sương mù</h5>
                <p>Sapa từ lâu đã được khách du lịch gọi với cái tên đầy thân thương đó là “nơi gặp gỡ đất trời” hay “thị trấn sương mù”.</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="https://media.travelmag.vn/files/conghieu/2020/10/22/106399793_3037897689619833_3533380904440208958_o-1338.jpg" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <h5>Đà Lạt - Chút suy tư của những kẻ mộng mơ</h5>
                <p>Đà Lạt, thành phố của những cung bậc cảm xúc. Nhắc đến Đà Lạt, người ta thường nhớ đến những khung cảnh tình yêu đầy mộng mơ mà vương chút bình yên.
                  <br>Từng rừng cây, từng mặt nước và đặc biệt là những cảnh sắc trời mây, tất cả đều tạo nên một Đà Lạt thi vị đến lạ kì.
                </p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="https://www.tourdulichuytin.com/images/hoi-an-dep-co-kinh.jpg" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <h5>Hội An - Thành phố cổ "vượt thời gian"</h5>
                <p>Khoảnh khắc khi chúng ta bước vào phố cổ Hội An, sự huyền bí của một thị trấn cổ hẻo lánh cách biệt với thế giới hiện đại
                  <br>Sẽ khiến bạn cảm thấy như đang du hành ngược thời gian, đến với xã hội nông thôn cũ của Việt Nam.
                </p>
              </div>
            </div>
          </div>
  ...
  <section class="container">
    <h1 class="text-center mb-5">KINH NGHIỆM DU LỊCH</h1>
    <div class="row">
      <div class="col-lg-4 col-md-4">
        <div class="facilities-item">
          <a href="hanoi.html">
            <img src="https://bcp.cdnchinhphu.vn/Uploaded/buithuhuong/2017_11_21/nhung-dieu-can-biet-khi-du-lich-ha-noi-2.jpg" alt="" />
            <h2>Hà Nội</h2>
            <p>Nhắc đến thủ đô Hà Nội, người ta thường nghĩ đến hình ảnh một thành phố cổ kính, với những lịch sử, văn hóa nghìn năm;
              nhưng tồn tại song song là một thành phố năng động, hiện đại với rất nhiều hoạt động giải trí thú vị. </p>
          </a>
        </div>
      </div>
      <div class="col-lg-4 col-md-4">
        <div class="facilities-item">
          <a href="danang.html">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Han_River_Bridge_in_Vietnam_Night_View.jpg/1920px-Han_River_Bridge_in_Vietnam_Night_View.jpg" alt="" />
            <h2>Đà Nẵng</h2>
            <p>
              Kinh nghiệm du lịch Đà Nẵng - thành phố đáng sống và dành cho du lịch nhất Việt Nam dành cho bạn
            </p>
          </a>
        </div>
      </div>
      <div class="col-lg-4 col-md-4">
        <div class="facilities-item">
          <a href="cantho.html">
            <img src="https://upload.wikimedia.org/wikipedia/commons/c/cc/C%E1%BA%A7u_V%C3%A0m_C%E1%BB%91ng.png" alt="" />
            <h2>Cần Thơ</h2>
            <p>
              Cần Thơ gạo trắng nước trong – Ai đi đến đó lòng không muốn về” là câu ca dao gắn liền với mảnh đất trù phú Cần Thơ. Nét hiện đại của phố xen lẫn với mộc mạc bình dị của miệt vườn miền Tây quanh năm ngập tràn cây trái là địa điểm du lịch Cần Thơ đầy cuốn hút đặc biệt của vùng đất này.
            </p>
          </a>
        </div>
      </div>
    ...
    <div class="modal-container js-modal-container">
      ...
      <form enctype="multipart/form-data" id="myform" action="login.php" method="post">
        ...
        <div class="modal-body">
          ...
          <input id="contact-phone" name="password" type="password" class="modal-input" placeholder="Nhập mật khẩu của bạn ..." required title="Mật khẩu không được để trống" />
          <input type="submit" id="btn-submit" value="Đăng Nhập" />
        </div>

        <div class="modal-footer">
          <p class="modal-help">Bạn cần <a href="">giúp ?</a></p>
        </div>
      </form>
    </div>
  </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true"> <i class="js-modal-close modal-close fas fa-times"></i></span>
          </button>
        </div>
        <div class="modal-body">
          <form enctype="multipart/form-data" id="myform" action="register.php" method="post">
            ...
            <div class="form-group">
              ...
              <input id="contact-phone" name="passwordComfirm" type="password" class="modal-input" placeholder="Nhập mật khẩu của bạn ..." required title="Mật khẩu không được để trống" />
            </div>
